      ...
      >
        {repeated.map((item, i) => (
          <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: '3rem' }}>
            ...
            <span style={{ width: '4px', height: '4px', borderRadius: '50%', background: '#C8A15A', display: 'inline-block', flexShrink: 0 }} />
          </span>
        ))}
      </motion.div>
    </div>
  ...
  return (
    ...
    >
      <div className="site-container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ marginBottom: '3rem' }}>
          <motion.p
            ...
            className="font-body"
            style={{ color: '#C8A15A', fontSize: '0.7rem', letterSpacing: '0.22em', textTransform: 'uppercase', marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}
          >
      ...
      <div className="site-container" style={{ position: 'relative', zIndex: 1, paddingBottom: '6rem' }}>
        <div className="contact-cols" style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '5rem', alignItems: 'start' }}>
          ...
          >
            <p className="font-body" style={{ color: '#555', fontSize: '0.8rem', letterSpacing: '0.04em', marginBottom: '2.5rem', lineHeight: 1.7 }}>
            ...
            {sent ? (
              ...
              >
                <p className="font-heading" style={{ fontSize: '1.5rem', color: '#C8A15A', marginBottom: '0.5rem' }}>Message sent ✓</p>
                <p className="font-body" style={{ color: '#A1A1A1', fontSize: '0.875rem' }}>I&apos;ll be in touch shortly.</p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit}>
                <Field label="Your Name"      value={form.name}    onChange={(v) => setForm({ ...form, name: v })}    placeholder="John Doe" />
                <Field label="Email Address"  type="email" value={form.email}   onChange={(v) => setForm({ ...form, email: v })}   placeholder="you@example.com" />
                <Field label="Your Message"   value={form.message} onChange={(v) => setForm({ ...form, message: v })} placeholder="Tell me about your idea…" multiline />
            ...
            {[
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <p className="font-body" style={{ fontSize: '0.65rem', color: '#555', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '0.15rem' }}>
                      {label}
                    </p>
